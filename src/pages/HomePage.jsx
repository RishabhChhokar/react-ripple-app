...
const AnalyticsCard = ({ title, value }) => (
  <div className="card h-13 p-2 bg-slate-300 shadow-slate-400 rounded-sm flex flex-col justify-center">
...
const HomePage = () => {
  ...
  return isLoggedIn ? (
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 pt-2">
